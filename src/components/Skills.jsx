      ...
      <div className="container">
        ...
        <div className="card-wrapper">
          <div className="skill-card">
            ...
            <h2>HTML</h2>
            <p>
              Crafting structured and semantic web content with modern
              standards.
            </p>
          </div>
          <div className="skill-card">
            ...
            <h2>JavaScript</h2>
            <p>
              Building interactive, dynamic web applications with efficient,
              functional code.
            </p>
          </div>
          <div className="skill-card">
            ...
            <h2>CSS</h2>
            <p>
              Designing visually appealing, responsive layouts with precision
              and creativity.
            </p>
          </div>
          <div className="skill-card">
            ...
            <h2>Tailwind CSS</h2>
            <p>
              Developing sleek, customizable interfaces using utility-first CSS
              framework.
            </p>
          </div>
          <div className="skill-card">
            ...
            <h2>TypeScript</h2>
            <p>
              Building scalable and maintainable web applications with static
          ...
          <div className="skill-card">
            ...
            <h2>React JS</h2>
            <p>
              Building dynamic and efficient user interfaces with React's
          ...
          <div className="skill-card">
            ...
            <h2>Figma</h2>
            <p>
              Designing intuitive, pixel-perfect interfaces with collaborative
          ...
          <div className="skill-card">
            ...
            <h2>SCSS</h2>
            <p>
              Crafting efficient, maintainable stylesheets with the power of
              SASS for scalable web design.
            </p>
          </div>
        </div>
      </div>
