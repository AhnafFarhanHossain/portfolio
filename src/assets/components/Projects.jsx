...
import GroupFlow from "../images/groupflow-landing-page.webp";
      ...
      <div className="container">
        ...
        <div className="projects-wrapper" ref={sliderRef}>
          ...
          <div className="card">
            ...
            <p>
              Feedlytic is a client-centric feedback management system that
              streamlines the collection, analysis, and visualization of
              customer insights.
            </p>
          ...
          {/* Project: GroupFlow - Group Project Management Platform */}
          <div className="card">
            <div className="card-top">
              <h2>GroupFlow - Project Management Platform</h2>
              <a href="https://groupflow-ahnaf.vercel.app" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={16}
                  height={16}
            ...
            <p>
              GroupFlow is a collaborative group projects management app that
              lets the users create groups and manage their group tasks easily.
              The app features a real-time chat application to ease the work
              flow.
            </p>
            <div className="tech-stack">
              <span>React JS</span>
            ...
            <img src={GroupFlow} alt="Shadient Website" />
          </div>
